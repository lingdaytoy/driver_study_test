 ...
 *          一次只有一个线程可以访问共享资源
 * @Author: dwl
 * @Date: 2024-12-07 21:20:46
 * @LastEditTime: 2024-12-07 22:12:06
 * @LastEditors: Do not edit
 * @FilePath: /character_device/12_07_mutex/mutex.c
 */
...
#if 0
    mutex_lock(&gpioled.mutex); // 不能被信号打断
#endif
